...
{
    /// <summary>
    /// Filesystem layout under UserData/Inkubator. Import = drop-zone for source PNGs; Projects = editable
    /// projects; Exports = ready-to-release mod folders.
    /// </summary>
    public static class Paths
    {
        public static string Root => Path.Combine(MelonEnvironment.UserDataDirectory, "Inkubator");
        ...
        public static string BakedDir(string name) => Path.Combine(ProjectDir(name), "baked");
